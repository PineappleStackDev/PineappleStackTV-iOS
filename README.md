...
- Full EPG guide with Schedule Direct support
- DVR management: record, schedule series rules, extend, stop
- Recording playback with seek, pause, and resume
- Channel surfing via Siri Remote
- Favorites, search, and direct channel number entry
